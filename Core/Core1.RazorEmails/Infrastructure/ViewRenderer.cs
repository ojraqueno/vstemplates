...
namespace Core1.RazorEmails.Infrastructure
{
    ...
    {
        Task<string> RenderViewToStringAsync<TModel>(TModel model) where TModel : BaseEmailViewModel;
    }
    ...
    public sealed class ViewRenderer : IViewRenderer
    {
        ...
        public async Task<string> RenderViewToStringAsync<TModel>(TModel model) where TModel : BaseEmailViewModel
        {
            var viewName = $"/EmailViews{model.ViewPath}.cshtml";
