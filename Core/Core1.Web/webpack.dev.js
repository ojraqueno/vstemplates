...
module.exports = {
    ...
    entry: {
        ...
        'accounts-index': './wwwroot/js/accounts/index.js',
        ...
        'admin-index': './wwwroot/js/admin/index.js',
        'emails-index': './wwwroot/js/emails/index.js',
        'filters': './wwwroot/js/shared/filters.js',
        'logs-index': './wwwroot/js/logs/index.js',
